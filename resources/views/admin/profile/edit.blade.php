            ...
            <div class="card-body" style="background-color: #f5f5dc;">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('admin.profiles.update', ['profile' => $user->id]) }}">
                    ...
                    <div class="form-group row form-check">
                        <label class="col-md-4 text-md-right form-check-label" for="isAdminCheck">Admin</label>

                            <input type="checkbox" class="form-check-input col-md-1" id="isAdminCheck" name="is_admin" @if($user->is_admin) checked="checked" @endif>
                    </div>
